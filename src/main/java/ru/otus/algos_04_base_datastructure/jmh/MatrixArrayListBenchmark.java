...
//import ru.otus.algos_04_base_datastructure.arrays.MatrixArrayList;
//
...
//@Fork(1)
//@Threads(1)
//public class MatrixArrayListBenchmark<T> {
//
//    MatrixArrayList<Integer> array;
//
//    @Setup(Level.Invocation)
//    public void setUp() {
//        array = new MatrixArrayList<>(3);
//        array.add(0, 0);
//        array.add(1, 1);
//        array.add(2, 2);
//    }
...
//        return array.remove(2);
//    }
//
//    private static class MatrixArrayList<T> {
//
...
////        MatrixArrayListBenchmark<Integer> freeArray = new MatrixArrayListBenchmark<>();
////        freeArray.add(0, 0);
////        freeArray.add(1, 1);
////        freeArray.add(2, 2);
////
